...
<div style={styles.body}> 
    <div style={styles.container}>
      ...
      <div style={{ ...styles.section, ...styles.homeSection }}>
        ...
        GeoTracker is a web app that provides real-time location details, including country, city, 
        ISP, and geographical coordinates based on the user's IP address. 
        It offers a user-friendly interface to visualize IP-based geo-information efficiently.
        </p>
      </div>
